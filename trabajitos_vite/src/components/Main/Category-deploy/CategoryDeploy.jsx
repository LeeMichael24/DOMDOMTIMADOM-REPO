    ...
    return (
        <div className={classes["section-izquierda"]}>
            ...
            <li className={classes["list_item"]}>
                ...
                <li className={classes["list_item list_item--click"]}>
                    <div className={classes["list_button list_button--click"]}>
                        <img src={dash} className={classes["list_img"]}/>
                    ...
                    <ul className={classes["list_show"]}>
                        <li className={classes["list_inside"]}>
                            <a href="#" className={classes["nav_link nav_link--inside"]}>Estoy dentro</a>
                        </li>
                        <li className={classes["list_inside"]}>
                            <a href="#" className={classes["nav_link nav_link--inside"]}>Estoy dentro</a>
                        </li>
